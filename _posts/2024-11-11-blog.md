...
### 작성자 류기민
	1.	퇴사 결심과 의미: 9년간의 회사 생활을 마치며, 개인의 주관적인 삶을 찾는 계기로 삼음.
	2.	이직 준비 과정: 명확한 비즈니스 모델과 큰 사용자 기반을 갖춘 회사를 목표로 지원 준비, 면접 실패와 자기 반성 과정.
	3.	새로운 기회와 배움: 여러 실패를 겪으며 면접 준비 방식을 개선, 스스로의 역량을 높이며 더 나은 회사를 찾기 위해 노력.
